		...
		<div class="bg2">
			<div class="main">
				...
				<ul id="menu">
					...
					<li class="active"><a href="Services.jsp">服务内容</a></li>
					<li><a href="../RoomShowServlet">房间展示</a></li>
				</ul>
				</nav>
				<!-- header end -->
				<!-- content -->
				...
				<div class="box1">
					<div class="wrapper">
						...
						<div class="col2 pad">
							<h2>
								<img src="images/title_marker1.jpg" alt="">特色服务
							</h2>
							<div class="wrapper pad_bot2">
								<figure class="left marg_right1">
								<img src="images/page2_img1.jpg" alt=""></figure>
							...
							<div class="wrapper">
								<figure class="left marg_right1">
								<img src="images/page2_img2.jpg" alt=""></figure>
								<p class="pad_bot1">宴会厅设施齐全，功能先进，装修豪华，可为各种酒会、宴会和文艺演出等予以妥善完备安排，根据客户特别需要，提供专业服务，迎合不同需求；会议中心配有先进的影音及灯光设备，亦可根据客人需要，提供大小不等的会议室，以满足商务客人不同的会议需求。</p>
							</div>
						</div>
					</div>
				</div>

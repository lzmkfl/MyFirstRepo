    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span> 住宿查询
            </div>
        </div>
        <div class="tpl-block">
            <div class="am-g">
                        ...
                        <table class="am-table am-table-striped am-table-hover table-main">
                            <thead>
                                <tr>
                                    ...
                                    <th class="table-author am-hide-sm-only">入住日期</th>
                            ...
                            <tbody>
                            <c:forEach items="${list }" var="cie"> 
                                <tr>
                                    <td><input type="checkbox"></td>
                                    <td>${cie.ciId}</td>
                                    <td><a href="#">${cie.cuName }</a></td>
                                    <td>${cie.rNo }</td>
                                    <td>${cie.check_date }</td>
                                    <td class="am-hide-sm-only">${cie.type }</td>
                                       <td>${cie.phoneNum }</td>
                                    <td class="am-hide-sm-only">${cie.remarks }</td>
                                    <td>
